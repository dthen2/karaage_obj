...
PLACES = [    {'x': 400., 'y': 300, 'size': 100., 'class': 'Place1'}\
            , {'x': 900., 'y': 300, 'size': 100., 'class': 'Place1'}\
            , {'x': 400., 'y': 600, 'size': 100., 'class': 'Place1'}\
            , {'x': 900., 'y': 600, 'size': 100., 'class': 'Place1'}\
        ]
...
class Apply7:
    ...
    def app_main7(self):
        ...
        for work in self.works : # work 毎に処理を走らせる
            # データ処理本体
            cogni_dict = work.cogRelation.relation_evaluation(time_g())
            # アップロードする新しいデータ作成
