...
class ID_NetWork:
    ...
    # relation_IDs を追加。「行為」などのIDを格納する 2022Feb2
    INITIAL_PROPERY = { \
    ...
    def relation_type_str(self):
        tystr = {"equal": "Detected or judged they are same participant", \
                ...
                "part": "A part of a participant. From is the participant, and To is upper.", \
                "predicate": "A predicate of a verb. In other word, target. From is the subject, and To is the predicate" ,\
